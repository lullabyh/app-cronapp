...
public interface UserDAO extends JpaRepository<User, java.lang.String> {
  ...
  public Page<PARTICIPANTE> findPARTICIPANTE(@Param(value="id") java.lang.String id, Pageable pageable);
  ...
  public Page<User> findUsersByPaRTICIPANTE(@Param(value="id") java.lang.String id, Pageable pageable);
